...
from .views import CartView, AddToCartView, UpdateCartItemView, RemoveCartItemView,CheckoutView,StripeCheckoutView,UserOrderListView, UserOrderDetailView,CancelOrderView,AdminOrderListView,AdminOrdersByStatusView,AdminOverviewView,AdminPopularDealsView,AdminPopularItemsView,AdminRevenueByRestaurantView,AdminRevenueOverTimeView,AdminUpdateOrderStatusView
urlpatterns = [
