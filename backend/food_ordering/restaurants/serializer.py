...
class AllRestaurantSerializer(serializers.ModelSerializer):
    class Meta:
        model = Restaurants
        fields = ['id','name', "address","image","is_featured","is_active",'created_by','created_at']
...
class AllCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ['id','name','image','restaurant_count','created_by','created_at']
    def get_restaurant_count(self, obj):
        return obj.menu_items.values("restaurant_id").distinct().count()
