      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-15">
          ...
          <div className="lg:ml-0 lg:pl-4">
            <p className="text-orange-500 font-bold text-sm sm:text-base">LIMITED TIME OFFER</p>

            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-2">{deal.name}</h1>
            ...
            <div className="flex items-center gap-3 mt-6 sm:mt-8">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base">Free Delivery</h3>
                <p className="text-gray-500 text-xs sm:text-sm">Delivery in 20-30 Minutes</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-10">
              <div className="flex items-center border rounded-full">
                ...
                <span className="px-4 sm:px-5 md:px-6 font-bold text-sm sm:text-base">{qty}</span>
          ...
          {deal.items.map((item) => (
            ...
            >
              ...
              <div className="p-3 sm:p-4">
                <h3 className="font-bold text-sm sm:text-base">{item.menu_item.name}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 sm:mt-14 md:mt-16">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-5 md:p-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
          ...
          <button
            ...
            onClick={() =>
              navigate(`/restaurants/${deal.items[0]?.menu_item.restaurant?.id}`)
            }
          >
            View Restaurant
          </button>
