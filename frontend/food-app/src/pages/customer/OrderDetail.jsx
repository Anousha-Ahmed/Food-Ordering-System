        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-5">
              ...
              <span className={`px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 rounded-full text-white font-semibold text-xs sm:text-sm ${getStatusColor(order.current_status)}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-4 sm:mt-6 md:mt-8">
              <div>
                <p className="text-gray-500 text-sm sm:text-base">Delivery Address</p>
          ...
          <div className="mt-8 sm:mt-10">
            ...
            <div className="space-y-4 sm:space-y-5">
              {order.items.map((item) => (
                <div key={item.id} className="bg-white rounded-xl shadow-md p-4 sm:p-5 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start sm:items-center">
                  <img
