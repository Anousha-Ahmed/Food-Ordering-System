      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {reviews.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-md px-4 sm:px-5 md:px-6 lg:px-7 py-4 sm:py-5 md:py-6 h-auto sm:h-[230px] md:h-[240px] lg:h-[250px] shadow-sm"
            >
              {/* Top */}
        ...
        {/* Bottom Rating */}
        <div className="hidden lg:block absolute right-0 sm:right-10 md:right-20 lg:right-40 bottom-[-30px] sm:bottom-[-20px] md:bottom-[-10px] lg:bottom-[30px]">
          <img
            src={Review}
            alt=""
